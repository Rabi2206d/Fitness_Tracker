                                    ...
                                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                        <div data-simplebar>
                                            ...
                                            <div class="dropdown-item bg-transparent text-wrap">
                                                <Link href="index.html" class="btn btn-soft-secondary btn-sm rounded-pill">how to setup <i class="mdi mdi-magnify ms-1"></i></Link>
                                                <Link href="index.html" class="btn btn-soft-secondary btn-sm rounded-pill">buttons <i class="mdi mdi-magnify ms-1"></i></Link>
                                            </div>
                                            ...
                                            <div class="notification-list">
                                                <Link to="" class="dropdown-item notify-item py-2">
                                                    <div class="d-flex">
                                        ...
                                        <div class="text-center pt-3 pb-1">
                                            <Link href="pages-search-results.html" class="btn btn-primary btn-sm">View All Results <i class="ri-arrow-right-line ms-1"></i></Link>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <Link to="" class="dropdown-item notify-item language py-2" data-lang="en" title="English">
                                            <img src="assets/images/flags/us.svg" alt="user-image" class="me-2 rounded" height="18" />
                                            <span class="align-middle">English</span>
                                        </Link>
                                        <Link to="" class="dropdown-item notify-item language" data-lang="sp" title="Spanish">
                                            <img src="assets/images/flags/spain.svg" alt="user-image" class="me-2 rounded" height="18" />
                                            <span class="align-middle">Española</span>
                                        </Link>
                                        <Link to="" class="dropdown-item notify-item language" data-lang="gr" title="German">
                                            <img src="assets/images/flags/germany.svg" alt="user-image" class="me-2 rounded" height="18" />
                                            <span class="align-middle">Deutsche</span>
                                        </Link>
                                        <Link to="" class="dropdown-item notify-item language" data-lang="it" title="Italian">
                                            <img src="assets/images/flags/italy.svg" alt="user-image" class="me-2 rounded" height="18" />
                                            <span class="align-middle">Italiana</span>
                                        </Link>
                                        <Link to="" class="dropdown-item notify-item language" data-lang="ru" title="Russian">
                                            <img src="assets/images/flags/russia.svg" alt="user-image" class="me-2 rounded" height="18" />
                                            <span class="align-middle">русский</span>
                                        </Link>
                                        <Link to="" class="dropdown-item notify-item language" data-lang="ch" title="Chinese">
                                            <img src="assets/images/flags/china.svg" alt="user-image" class="me-2 rounded" height="18" />
                                            <span class="align-middle">中国人</span>
                                        </Link>
                                        <Link to="" class="dropdown-item notify-item language" data-lang="fr" title="French">
                                            <img src="assets/images/flags/french.svg" alt="user-image" class="me-2 rounded" height="18" />
                                            <span class="align-middle">français</span>
                                        </Link>
                                        <Link to="" class="dropdown-item notify-item language" data-lang="ar" title="Arabic">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-auto">
                                                    <Link href="#!" class="btn btn-sm btn-soft-info">View All Apps
                                        ...
                                        <div class="p-2">
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col">
                                                    <Link class="dropdown-icon-item" href="#!">
                                                        <img src="assets/images/brands/mail_chimp.png" alt="Mail Chimp" />
                                            ...
                                            <div class="px-2 pt-2">
                                                <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom" data-dropdown-tabs="true" id="notificationItemsTab" role="tablist">
                                                    <li class="nav-item waves-effect waves-light">
                                                        <Link class="nav-link active" data-bs-toggle="tab" href="#all-noti-tab" role="tab" aria-selected="true">
                                                            All (4)
                                                        </Link>
                                                    </li>
                                                    <li class="nav-item waves-effect waves-light">
                                                        <Link class="nav-link" data-bs-toggle="tab" href="#messages-tab" role="tab" aria-selected="false">
                                                            Messages
                                                        </Link>
                                                    </li>
                                                    <li class="nav-item waves-effect waves-light">
                                                        <Link class="nav-link" data-bs-toggle="tab" href="#alerts-tab" role="tab" aria-selected="false">
                                                            Alerts
                                                        </Link>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                                <div data-simplebar class="pe-2">
                                                    ...
                                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                                        <div class="d-flex">
                                                            <div class="me-3 rounded-circle avatar-xs flex-shrink-0">
                                                                <span class="avatar-title bg-info-subtle text-info rounded-circle fs-16"></span>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <Link href="#!" class="stretched-link">
                                            ...
                                            <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                                <div data-simplebar class="pe-2">
                                                    <div class="text-reset notification-item d-block dropdown-item">
                                                        <div class="d-flex">
                                                            <div class="me-3 rounded-circle avatar-xs">
                                                                <span class="avatar-title bg-info-subtle text-info rounded-circle fs-16"></span>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <Link href="#!" class="stretched-link">
                                                    ...
                                                    <div class="text-reset notification-item d-block dropdown-item">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="fs-13 text-muted">
                                                                    <p class="mb-1">Mentioned you in his comment on 📃 invoice #12501.</p>
                                                                </div>
                                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                    ...
                    <div id="scrollbar">
                        <div class="container-fluid">
                            ...
                            <ul class="navbar-nav" id="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <Link class="nav-link menu-link" href="#sidebarDashboards" >
